...
def main():
    ...
    with open("E:/000_Audiotext/T0_OUTPUT/TP_FIR_Q30.bin", "wb") as f:
        f.write(out)
    ...
    with open("E:/000_Audiotext/T0_OUTPUT/TP_FIR_SOURCE_DECIMAL.txt", "wb") as f:
        f.write(raw)
    ...
    print(report)
    with open("E:/000_Audiotext/T0_WORK/logs/tp_fir_log.txt", "w") as f:
        f.write(str(report) + "\n")
